...
def get_weather():
    ...
    url = "https://api.openweathermap.org/data/2.5/weather?q=Montreal&appid=0cb2ac05d114c97f71cd684279f6cf34&units=metric&lang=zh_cn"
    response = get(url)
    ...
    # 最高气温
    temp = "{:.2f}℃".format(weatherinfo["main"]["temp_max"])
    # 最低气温
    tempn = "{:.2f}℃".format(weatherinfo["main"]["temp_min"])
    print(weather, temp, tempn)
